...
const FormGenero = () => {
  ...
  useEffect(() => {
    if (id) {
      ...
      const fetchGenero = async () => {
        try {
          const data = await Generorepository.getGenerosById(id);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEdit) {
        ...
        await Generorepository.updateGeneros(id, formData);
      } else {
        // Si es creación, creamos la canción
        await Generorepository.createGeneros(formData);
      }
      navigate("/admin");
    } catch (error) {
      console.error(
  ...
  const handleDelete = async (id) => {
    try {
      await Generorepository.deleteGeneros(id);
      navigate("/admin");
    } catch (error) {
